...
public class GetProjectDashboardQueryTest : BaseFunctionalTest
{
    public GetProjectDashboardQueryTest(WebAppFactory factory) : base(factory)
    {
    }
    ...
    public async Task Should_ReturnSuccess_WhenDataIsValid()
    {
        ...
        // Act
        var result = await _sender.Send(new GetProjectDashboardQuery(), CancellationToken.None);
