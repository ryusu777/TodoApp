...
public class UpdateProjectHierarchyMembersDetailsCommandTest : BaseFunctionalTest
{
    public UpdateProjectHierarchyMembersDetailsCommandTest(WebAppFactory factory) : base(factory)
    {
    }
    ...
    public async Task Should_ReturnSuccess_WhenDataIsValid()
    {
        ...
        var project = new UpdateProjectHierarchyMembersCommand(
            "ProjectHierarchyA",
            Guid.NewGuid(),
            new string[] {}
        );
