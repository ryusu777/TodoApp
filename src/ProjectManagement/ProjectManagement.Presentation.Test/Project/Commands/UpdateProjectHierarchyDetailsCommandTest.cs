...
public class UpdateProjectHierarchyDetailsDetailsCommandTest : BaseFunctionalTest
{
    public UpdateProjectHierarchyDetailsDetailsCommandTest(WebAppFactory factory) : base(factory)
    {
    }
    ...
    public async Task Should_ReturnSuccess_WhenDataIsValid()
    {
        ...
        var project = new UpdateProjectHierarchyDetailsCommand(
            "ProjectHierarchyA",
            Guid.NewGuid(),
            "Project Manager",
            null
