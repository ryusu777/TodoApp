...
public class DeleteSubdomainKnowledgeCommandTest : BaseFunctionalTest
{
    public DeleteSubdomainKnowledgeCommandTest(WebAppFactory factory) : base(factory)
    {
    }
    ...
    public async Task Should_ReturnSuccess_WhenDataIsValid()
    {
        ...
        var project = new DeleteSubdomainKnowledgeCommand(
            Guid.NewGuid(),
            Guid.NewGuid());
