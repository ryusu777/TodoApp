...
public class UpdateSubdomainKnowledgeCommandTest : BaseFunctionalTest
{
    public UpdateSubdomainKnowledgeCommandTest(WebAppFactory factory) : base(factory)
    {
    }
    ...
    public async Task Should_ReturnSuccess_WhenDataIsValid()
    {
        ...
        var project = new UpdateSubdomainKnowledgeCommand(
            Guid.NewGuid(),
            "Title",
            "Content",
            Guid.NewGuid());
